...
{
    public partial class ProjectingDataInDetailsView : Form
    {
        public ProjectingDataInDetailsView()
        {
            InitializeComponent();
        }
        ...
        private void ProjectingDataInDetailsView_Load(object sender, EventArgs e)
        {
